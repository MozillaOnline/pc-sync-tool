...
(function(global) {
  ...
  function ByteInputStream(bytes) { /** @type {number} */
    var pos = 0;
  ...
  function ByteOutputStream(bytes) { /** @type {number} */
    var pos = 0;
     ...
     */
    this.emit = function(var_args) { /** @type {number} */
      var last = EOF_byte;
      var i;
  ...
  function CodePointInputStream(string) {
    ...
    function stringToCodePoints(string) { /** @type {Array.<number>} */
      var cps = [];
  ...
  function CodePointOutputStream() { /** @type {string} */
    var string = '';
  ...
  function ISO2022KREncoder(options) {
    ...
    var /** @type {boolean} */
    iso2022kr_initialization = false,
         /** @type {number} */
        iso2022kr_state = state.ASCII;
    /**
     * @param {ByteOutputStream} output_byte_stream Output byte stream.
  ...
  function TextEncoder(opt_encoding, options) {
    ...
    options = Object(options); /** @private */
    this._encoding = getEncoding(opt_encoding);
    if (this._encoding === null || (this._encoding.name !== 'utf-8' && this._encoding.name !== 'utf-16' && this._encoding.name !== 'utf-16be')) throw new TypeError('Unknown encoding: ' + opt_encoding); /** @private @type {boolean} */
    this._streaming = false; /** @private */
    this._encoder = null; /** @private @type {{fatal: boolean}=} */
    this._options = {
  ...
  function TextDecoder(opt_encoding, options) {
    ...
    options = Object(options); /** @private */
    this._encoding = getEncoding(opt_encoding);
    if (this._encoding === null) throw new TypeError('Unknown encoding: ' + opt_encoding);

    /** @private @type {boolean} */
    this._streaming = false; /** @private */
    this._decoder = null; /** @private @type {{fatal: boolean}=} */
    this._options = {
      fatal: Boolean(options.fatal)
    };
